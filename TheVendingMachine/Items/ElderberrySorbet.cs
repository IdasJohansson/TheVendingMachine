...
namespace TheVendingMachine.Items
{
	public class ElderberrySorbet : IProduct
	{
        ...
        public void Description()
        {
            ...
            Console.WriteLine($"This sorbet is made of sugar and fruitjuice extracted from Elderberries harvested in the southern of Sweden. Best-before date: {bestBefore.ToString("dd-MM-yyyy")} ");
        }
