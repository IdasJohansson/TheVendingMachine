...
namespace TheVendingMachine.Items
{
    ...
    public class LemonSorbet : Product, IProduct
	{
        ...
        public void Description()
        {
            ...
            Console.WriteLine($"This sorbet is made of sugar and fruitjuice extracted from Lemons harvested in the southern of Sweden. Best-before date: {bestBefore.ToString("yyyy-MM-dd")} "); 
        }
