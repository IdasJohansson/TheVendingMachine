...
{
	public class Wildberry : Product, IProduct
	{
        ...
        public void Description()
        {
            ...
            string info = $"Theese berries are handpicked in the southern of Sweden. A mix of blueberries, blackberries and raspberries. Best-before date: {bestBefore.ToString("yyyy-MM-dd")} ";
            Console.WriteLine();
